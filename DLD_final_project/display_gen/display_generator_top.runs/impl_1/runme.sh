...
HD_PWD='C:/Users/ssnediker07/Desktop/CS373Final/final_project_chennai/display_gen/display_generator_top.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log display_generator_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source display_generator_top.tcl -notrace
