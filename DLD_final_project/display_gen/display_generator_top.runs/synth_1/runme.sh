...
HD_PWD='C:/Users/ssnediker07/Desktop/CS373Final/final_project_chennai/display_gen/display_generator_top.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log display_generator_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source display_generator_top.tcl
